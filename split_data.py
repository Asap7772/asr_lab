...
argparser.add_argument('--output_path', type=str, default='/Users/anikaitsingh/Desktop/speech_dataset/data_anikait_10min', help='output path')
argparser.add_argument('--proportion', type=float, default=0.5, help='proportion of data to keep')
...
for split, split_csv in split_csvs.items():
    ...
    for i in range(num_rows):
        ...
        os.system(f"cp {os.path.join(data_path, row_filename)} {os.path.join(output_path, row_filename)}")
